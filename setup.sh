...
main() {
    ...
    local SETUP_URL="https://raw.githubusercontent.com/eng209/eng209_2025/refs/heads/main/setup.py"
    ...
    [[ -e setup.py ]] || "${PYTHON_PATH}" -c "import urllib.request; urllib.request.urlretrieve('${SETUP_URL}', 'setup.py')"
